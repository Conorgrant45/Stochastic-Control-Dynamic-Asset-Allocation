...
\item \textbf{Convergence Assessment:} The relative error facilitates clear visualization of convergence rates (e.g., Monte Carlo error decay) on log--log plots by removing scale effects.
\end{itemize}
