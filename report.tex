...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{figures/ex2_combined_losses.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/Value_Function_Convergence1.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{lccr}
        ...
        \midrule
        Value $v(0, x_0)$                            & 0.8347 & 0.8534 & 0.0218 \\
        Control $a_1(0, x_0)$                        & -2.0873  & -3.2697  & 0.3617 \\
        Control $a_2(0, x_0)$                        & -2.6231  & -3.2697  & 0.1977 \\
        $\|a_{\mathrm{pred}} - a_{\mathrm{true}}\|$ & \multicolumn{2}{c}{(combined)} & 0.2914 \\
        \bottomrule
    \end{tabular}
